...
This project helped me get hands-on experience with frontend development fundamentals.
...
2. CSS Concepts I Practiced:
   ...
   Responsive design using media queries (@media).
   Background images and gradients.
   Box model, padding, and margin adjustments.
   Font styling and color combinations.
   Buttons, hover effects, and spacing for better user experience.
